# LLM judge packet - run `20260811T150628Z-baseline`
...
2. Save its raw JSON reply to `benchmarks/judgments/20260811T150628Z-baseline.json`.
3. Score it:

   ```
   .venv-bench/Scripts/python.exe benchmarks/harness/score_judgments.py --run 20260811T150628Z-baseline
   ```
