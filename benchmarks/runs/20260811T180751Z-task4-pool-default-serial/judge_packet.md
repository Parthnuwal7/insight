# LLM judge packet - run `20260811T180751Z-task4-pool-default-serial`
...
2. Save its raw JSON reply to `benchmarks/judgments/20260811T180751Z-task4-pool-default-serial.json`.
3. Score it:

   ```
   .venv-bench/Scripts/python.exe benchmarks/harness/score_judgments.py --run 20260811T180751Z-task4-pool-default-serial
   ```
