# LLM judge packet - run `20260809T201004Z-translation-fixed`
...
2. Save its raw JSON reply to `benchmarks/judgments/20260809T201004Z-translation-fixed.json`.
3. Score it:

   ```
   .venv-bench/Scripts/python.exe benchmarks/harness/score_judgments.py --run 20260809T201004Z-translation-fixed
   ```
