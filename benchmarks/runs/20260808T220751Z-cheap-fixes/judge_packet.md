# LLM judge packet - run `20260808T220751Z-cheap-fixes`
...
2. Save its raw JSON reply to `benchmarks/judgments/20260808T220751Z-cheap-fixes.json`.
3. Score it:

   ```
   .venv-bench/Scripts/python.exe benchmarks/harness/score_judgments.py --run 20260808T220751Z-cheap-fixes
   ```
