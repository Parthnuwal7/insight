# LLM judge packet - run `20260808T121303Z-pyabsa-working`
...
2. Save its raw JSON reply to `benchmarks/judgments/20260808T121303Z-pyabsa-working.json`.
3. Score it:

   ```
   .venv-bench/Scripts/python.exe benchmarks/harness/score_judgments.py --run 20260808T121303Z-pyabsa-working
   ```
