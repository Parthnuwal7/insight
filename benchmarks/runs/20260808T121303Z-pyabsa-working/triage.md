...
| Metric | Value |
|---|---:|
| Aspect F1 (fuzzy match) | **0.713** |
| Aspect precision | 0.795 |
| Aspect recall | 0.646 |
| Sentiment accuracy (matched aspects only) | **0.8387** |
| Coverage ratio (predicted / gold aspects) | 0.812 |
| Aspects predicted / gold | 78 / 96 |
...
| `hindi` | 3 | 0.545 | 0.429 | 0.667 |
| `out_of_taxonomy` | 11 | 0.615 | 0.522 | 0.917 |
| `sarcasm` | 3 | 0.667 | 0.750 | 0.333 |
...
**#10** (`out_of_taxonomy`, `pyabsa_empty_to_fallback`) - F1 0.00
...
**#31** (`out_of_taxonomy`, `pyabsa_empty_to_fallback`) - F1 0.00

> Export function doesn't work. Tried multiple formats, all fail. Major bug.

- predicted: Performance:Negative, Features:Negative
